...
import language.arith.EqualOperator;
...
/**
 * <p>
 * An {@code ArithEquationParser} is a post fix parser for arithmetic
 * expressions.
 * </p>
 * <p>
 ...
 * <pre>
 * Example:
 *   PostFixParser<Integer> parser = new ArithEquationParser("1 2 +");
...
public class ArithEquationParser implements PostFixParser<Integer> {
    ...
    /**
     * Creates an {@link ArithEquationParser} over {@code expr}.
     * 
     * @param expr
